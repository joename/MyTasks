...
public class Task {
   ...
   * @param user
   */
  public Task(String taskname, String description, Date date, long idCategory, long idUser) {
    super();
  ...
  public String toString() {
    return "Task [id=" + idTask + ", taskname=" + taskname + ", description="
        + description + ", date=" + date + ", deadline=" + deadline + ", idCategory="
        + idCategory + ", idPriority=" + idPriority + ", idState=" + idState
        + ", idUser=" + idUser + ", idUserResponsible=" + idUserResponsible
        + ", evaluation=" + evaluation + ", timestamp=" + timestamp + ", pending="
        + pending + "]";
  }
