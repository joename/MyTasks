...
public class CategoryDao {
  ...
  public boolean delete(long idTaskCategory) {
    ...
    MapSqlParameterSource params = new MapSqlParameterSource("idTaskCategory",
                                                             idTaskCategory);

    return jdbc.update("delete from a_taskCategory where idTaskCategory=:idTaskCategory",
                       params) == 1;
  }
