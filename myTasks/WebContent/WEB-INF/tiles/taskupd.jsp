...
<div id="body" class="col-md-10">
	<div class="col-md-6">
		...
		<form:form method="POST" class="form-horizontal"
			...
			<div class="form-group">
				<label for="taskname" class="col-sm-2 control-label input-sm">Tarea</label>
				<div class="col-sm-10">
			...
			<div class="form-group">
				<label for="description" class="col-sm-2 control-label input-sm">Descripción</label>
				<div class="col-sm-10">
			...
			<div class="form-group">
				<label for="deadline" class="col-sm-2 control-label input-sm">Fecha
					límite</label>
				<div class="col-sm-10">
			...
			<div class="form-group">
				<label for="category" class="col-sm-2 control-label input-sm">Categoría</label>
				<div class="col-sm-10">
			...
			<div class="form-group">
				<label for="priority" class="col-sm-2 control-label input-sm">Prioridad</label>
				<div class="col-sm-10">
			...
			<div class="form-group">
				<label for="state" class="col-sm-2 control-label input-sm">Estado</label>
				<div class="col-sm-10">
			...
			<div class="form-group">
				<label for="pendingby" class="col-sm-2 control-label input-sm">Pendiente
					por</label>
				<div class="col-sm-10">
			...
			<div class="form-group">
				<label for="userresponsible" class="col-sm-2 control-label input-sm">Usuario
					responsable</label>
				<div class="col-sm-10">
			...
			<div class="form-group">
				<label for="evaluation" class="col-sm-2 control-label input-sm">Valoración</label>
				<div class="col-sm-10">
